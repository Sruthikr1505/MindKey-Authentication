...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 relative overflow-hidden transition-all duration-300">
      {/* Particle Background */}
      <ParticleBackground />
